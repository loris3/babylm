...
def main():
    ...
    parser.add_argument("--fast", action="store_true", help="Runs fast eval pipeline")
...
python -m evaluation_pipeline.sentence_zero_shot.run --model_path_or_name {model} --backend {"mlm" if model_type == "roberta" else "causal"} --task blimp --data_path "evaluation_data/fast_eval/blimp_fast" --save_predictions --revision_name main --output_dir={os.path.join(os.getcwd(),"results")}
python -m evaluation_pipeline.sentence_zero_shot.run --model_path_or_name {model} --backend {"mlm" if model_type == "roberta" else "causal"} --task blimp --data_path "evaluation_data/fast_eval/supplement_fast" --save_predictions --revision_name main --output_dir={os.path.join(os.getcwd(),"results")}
python -m evaluation_pipeline.sentence_zero_shot.run --model_path_or_name {model} --backend {"mlm" if model_type == "roberta" else "causal"} --task ewok --data_path "evaluation_data/fast_eval/ewok_fast" --save_predictions --revision_name main --output_dir={os.path.join(os.getcwd(),"results")}
python -m evaluation_pipeline.sentence_zero_shot.run --model_path_or_name {model} --backend {"mlm" if model_type == "roberta" else "causal"} --task wug --data_path "evaluation_data/fast_eval/wug_adj_nominalization" --save_predictions --revision_name main --output_dir={os.path.join(os.getcwd(),"results")}
python -m evaluation_pipeline.sentence_zero_shot.run --model_path_or_name {model} --backend {"mlm" if model_type == "roberta" else "causal"} --task entity_tracking --data_path "evaluation_data/fast_eval/entity_tracking_fast" --save_predictions --revision_name main --output_dir={os.path.join(os.getcwd(),"results")}
python -m evaluation_pipeline.reading.run --model_path_or_name {model} --backend {"mlm" if model_type == "roberta" else "causal"} --data_path "evaluation_data/fast_eval/reading/reading_data.csv" --revision_name main --output_dir={os.path.join(os.getcwd(),"results")}
